function change(index) {
  ...
  switch (index) {
    ...
    case 2:
      p.innerHTML =
        '<iframe width=100% height=100% src="./w05-bootstrap/w01-intro-pokemon/pokemon_bs.html" />';
      break;
    case 3:
      p.innerHTML =
        '<iframe width=100% height=100% src="./w05-bootstrap/w02-imgGallery/imgGallery-bs.html" />';
      break;
    case 4:
      p.innerHTML =
    ...
    case 6:
      p.innerHTML =
        '<iframe width=100% height=100% src="./w04-div-tku60-js/div_tku60.html" />';
      break;
    case 7:
      p.innerHTML =
